...
this["FirechatDefaultTemplates"]["up-templates/prompt-create-room.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'clearfix\'>\n<h6>Give your chat room a name:</h6>\n<input data-input=\'firechat-room-name\' type=\'text\' placeholder=\'Room name...\' style=\'margin-bottom: 5px;\' maxlength=\'' +__e( maxLengthRoomName ) +'\'>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/prompt-invitation.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<h5>' +__e( fromUserName ) +'</h5>\n<p>invited you to join</p>\n<h5>' +__e( toRoomName ) +'</h5>\n<p class=\'clearfix\'>\n<button data-toggle=\'accept\' type=\'button\' class=\'btn\'>Accept</button>\n<button data-toggle=\'decline\' type=\'button\' class=\'btn\'>Decline</button>\n</p>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/prompt-invite-private.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<h6>Invite <strong>' +__e( userName ) +'</strong> to ' +__e( roomName ) +'?</h6>\n<p class=\'clearfix\'>\n<button data-toggle=\'accept\' type=\'button\' class=\'btn\'>Invite</button>\n<button data-toggle=\'decline\' type=\'button\' class=\'close btn\'>Cancel</button>\n</p>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/prompt-invite-reply.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<h5>' +__e( toUserName ) +'</h5>\n<p>\n'; if (status === 'accepted') { ;__p += ' accepted your invite. '; } else { ;__p += ' declined your invite. '; } ;__p += '\n</p>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/prompt-user-mute.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'aligncenter clearfix\'>\n<h5>' +__e( userName ) +'</h5>\n<p class=\'clearfix\'>\n<button data-toggle=\'accept\' type=\'button\' class=\'btn\'>Mute</button>\n<button data-toggle=\'decline\' type=\'button\' class=\'btn\'>Cancel</button>\n</p>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/prompt.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div class=\'prompt hidden\'>\n<div class=\'prompt-header\'>\n' +__e( title ) +'\n<a href=\'#!\' class=\'close right\'>X</a>\n</div>\n<div class=\'prompt-body clearfix\'>\n' +((__t = ( content )) == null ? '' : __t) +'\n</div>\n<div class=\'prompt-footer\'></div>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/room-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-room-type=\'' +__e( type ) +'\' data-room-id=\'' +__e( id ) +'\' data-room-name=\'' +__e( name ) +'\'>\n<a href=\'#!\' class=\'clearfix '; if (isRoomOpen) { ;__p += ' highlight '; } ;__p += '\'>\n<span class=\'left\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>\n</a>\n</li>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/room-user-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'>\n<a href=\'#!\' class=\'clearfix\'>\n<span class=\'left twothird clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>'; if (!disableActions) { ;__p += '\n<span data-event=\'firechat-user-mute-toggle\' class=\'icon user-mute right '; if (isMuted) { ;__p += ' red '; } ;__p += '\' title=\'Toggle User Mute\'>&nbsp;</span>\n<span data-event=\'firechat-user-chat\' class=\'icon user-chat right\' title=\'Invite to Private Chat\'>&nbsp;</span>\n'; } ;__p += '\n</a>\n</li>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/room-user-search-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'>\n<a href=\'#!\' class=\'clearfix\'>\n'; if (disableActions) { ;__p += '\n<span class=\'left fourfifth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>\n'; } else { ;__p += '\n<span data-event=\'firechat-user-invite\' class=\'left fourfifth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>\n<span data-event=\'firechat-user-invite\' class=\'icon plus right\' title=\'Invite to Room\'>+</span>\n'; } ;__p += '\n</a>\n</li>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/tab-content.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<div id=\'' +__e( id ) +'\' data-room-id=\'' +__e( id ) +'\' class=\'tab-pane\'>\n<div class=\'tab-pane-menu clearfix\'>\n<!--\n<div class=\'dropdown twofifth\'>\n<a data-event=\'firechat-user-room-list-btn\' class=\'full btn dropdown-toggle\' data-toggle="dropdown" href=\'#\' data-target=\'firechat-room-user-list-' +__e( id ) +'\'>\n<span class=\'icon user-group\'></span>\nIn Room\n<span class=\'caret\'></span>\n</a>\n<div class=\'dropdown-menu\' role=\'menu\'>\n<ul id=\'firechat-room-user-list-' +__e( id ) +'\' class=\'full\'></ul>\n</div>\n</div><div class=\'dropdown twofifth\'>\n<a data-event=\'firechat-user-search-btn\' class=\'full btn dropdown-toggle\' data-toggle="dropdown" href=\'#\'>\n<span class=\'icon plus\'>+</span>\nInvite\n<span class=\'caret\'></span>\n</a><div class=\'dropdown-menu\' role=\'menu\'>\n<div class=\'dropdown-header aligncenter clearfix\'>\n<div class=\'search-wrapper\'>\n<span class=\'icon search\'></span>\n<input type=\'text\' data-event=\'firechat-user-search\' data-template=\'up-templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' class=\'center fivesixth\'>\n</div>\n</div>\n<ul id=\'firechat-room-user-search-' +__e( id ) +'\'></ul><div class=\'dropdown-footer aligncenter clearfix\'>\n<div id=\'firechat-room-user-search-controls-' +__e( id ) +'\' class=\'clearfix\'><span class="quarter"></span><button type=\'button\' class=\'btn third disabled\' data-event=\'firechat-user-search\' data-template=\'templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' data-toggle=\'firechat-pagination-prev\' disabled=disabled>Prev</button><button type=\'button\' class=\'btn half disabled\' data-event=\'firechat-user-search\' data-template=\'up-templates/room-user-search-list-item.html\' data-target=\'firechat-room-user-search-' +__e( id ) +'\' data-controls=\'firechat-room-user-search-controls-' +__e( id ) +'\' data-toggle=\'firechat-pagination-next\'  disabled=disabled>Next</button>\n</div>\n</div>\n</div>\n</div>\n-->\n<a href=\'#!\' data-event=\'firechat-close-tab\' class=\'icon close right\' style=\'15px 5px\' title=\'Leave Room\'></a></div><div class=\'clearfix\'>\n<div id=\'firechat-messages' +__e( id ) +'\' class=\'chat\'></div>\n</div><div class=\'clearfix\'>\n<label>Your message:</label>\n<textarea id=\'textarea' +__e( id ) +'\' placeholder=\'Type your message here...\'></textarea>\n</div>\n</div>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/tab-menu-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape;with (obj) {__p += '<li data-room-id=\'' +__e( id ) +'\'>\n<a href=\'#' +__e( id ) +'\' data-toggle=\'tab\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</a>\n</li>';}return __p};

this["FirechatDefaultTemplates"]["up-templates/user-search-list-item.html"] = function(obj) {obj || (obj = {});var __t, __p = '', __e = _.escape, __j = Array.prototype.join;function print() { __p += __j.call(arguments, '') }with (obj) {__p += '<li data-user-id=\'' +__e( id ) +'\' data-user-name=\'' +__e( name ) +'\'>\n<a href=\'#!\' class=\'clearfix\'>\n'; if (disableActions) { ;__p += '\n<span class=\'left fivesixth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>\n'; } else { ;__p += '\n<span data-event=\'firechat-user-chat\' class=\'left fivesixth clipped\' title=\'' +__e( name ) +'\'>' +__e( name ) +'</span>\n<span data-event=\'firechat-user-chat\' class=\'icon user-chat right\' title=\'Invite to Private Chat\'>&nbsp;</span>\n'; } ;__p += '\n</a>\n</li>';}return __p};
(function($) {
...
(function(Firebase) {
  ...
  function Firechat(firebaseRef, options) {
    ...
    this._userIdsOnlineRef = this._firebase.child('user-ids-online');
  ...
  Firechat.prototype = {
    ...
    _setupDataEvents: function() {
      ...
      var userIdRef = this._userIdsOnlineRef.child(this._userId);
      userIdRef.child("online").onDisconnect().set(false);
      userIdRef.child("online").set(true);
...
//          console.log(onlineRef.parent().toString() + "   User: " + self._friendList[uk] + "  " + (oval ? "Is online" : "Is OFFLINE"));
  ...
  Firechat.prototype.addFriendToWatch = function(friend, cb) {
    this.setupWatch(friend, cb);
  };

  Firechat.prototype.addFriendsToWatch = function(friends, cb) {
    console.log("watchForFriends");
...
/*
  Firechat.prototype.setFriends = function(friendList) {
    this._friendList = friendList;

    // Subscribe to each friend's 
    this.watchForFriends();
  };
*/
  Firechat.prototype.addFriend = function(friendId, friendName, friendUniversity) {
    // addFriend: This method will add a friend to the system's friend list
...
//WDS: UP version of the Firechat UI...
  ...
  FirechatUI.prototype = {
    ...
    _renderLayout: function() {
      var template = FirechatDefaultTemplates["up-templates/layout-full.html"];
...
/* END internal functions */
  ...
  /**
   * Get this instance's chat reference.  User for internal debug.
   */
    ...
    var self = this,
        ...
        showMessageContextMenu = function(event) {
          var $this = $(this),
              ...
              template = FirechatDefaultTemplates["up-templates/message-context-menu.html"],
  ...
  FirechatUI.prototype._bindForRoomList = function() {
    ...
    $('#firechat-btn-rooms').bind('click', function() {
      ...
      var $this = $(this),
          template = FirechatDefaultTemplates["up-templates/room-list-item.html"],
  ...
  FirechatUI.prototype._bindForUserRoomList = function() {
    ...
    $(document).delegate('[data-event="firechat-user-room-list-btn"]', 'click', function(event) {
      ...
      var $this = $(this),
          ...
          template = FirechatDefaultTemplates["up-templates/room-user-list-item.html"],
  ...
  FirechatUI.prototype._bindForUserMuting = function() {
    ...
    $(document).delegate('[data-event="firechat-user-mute-toggle"]', 'click', function(event) {
      var $this = $(this),
          ...
          template = FirechatDefaultTemplates["up-templates/prompt-user-mute.html"];
    ...
    var self = this,
        renderInvitePrompt = function(event) {
          var $this = $(this),
              ...
              roomId = $this.closest('[data-room-id]').data('room-id'),
              userName = $this.closest('[data-user-name]').data('user-name'),
              template = FirechatDefaultTemplates["up-templates/prompt-invite-private.html"],
              $prompt;
  ...
  FirechatUI.prototype.renderAlertPrompt = function(title, message) {
    var template = FirechatDefaultTemplates["up-templates/prompt-alert.html"],
  ...
  FirechatUI.prototype.attachTab = function(roomId, roomName) {
    ...
    var tabTemplate = FirechatDefaultTemplates["up-templates/tab-content.html"];
    ...
    var tabListTemplate = FirechatDefaultTemplates["up-templates/tab-menu-item.html"];
  ...
  FirechatUI.prototype.showMessage = function(roomId, rawMessage) {
    ...
    var template = FirechatDefaultTemplates["up-templates/message.html"];
    ...
    if ($messages) {
      ...
      //WDS: See if we can auto-focus the tab.
      self.focusTab(roomId);
    }
  };
  ...
  FirechatUI.prototype.promptCreateRoom = function() {
    var self = this;
    var template = FirechatDefaultTemplates["up-templates/prompt-create-room.html"];
  ...
  FirechatUI.prototype.prompt = function(title, content) {
    var template = FirechatDefaultTemplates["up-templates/prompt.html"],
        $prompt;
